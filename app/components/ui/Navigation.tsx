...
export function Navigation() {
    ...
    if (pathname === '/' || pathname.startsWith('/login') || pathname.startsWith('/signup') || pathname.startsWith('/homepage') || pathname.startsWith('/testing') || pathname.startsWith('/training') || pathname.startsWith('/settings') || pathname.startsWith('/docs')) {
        return null;
    }
